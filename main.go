...
var typeOfByteSlice = reflect.TypeOf([]byte{}).String()
...
var (
	typeOfDate     = reflect.TypeOf(civil.Date{}).String()
	typeOfTime     = reflect.TypeOf(civil.Time{}).String()
	typeOfDateTime = reflect.TypeOf(civil.DateTime{}).String()
	typeOfGoTime   = reflect.TypeOf(time.Time{}).String()
	typeOfRat      = reflect.TypeOf(&big.Rat{}).String()
)

var (
	// NOTE(djeeno): ref. https://github.com/googleapis/google-cloud-go/blob/f37f118c87d4d0a77a554515a430ae06e5852294/bigquery/params.go#L157-L167
	typeOfInt64   = reflect.Int64.String()
	typeOfString  = reflect.String.String()
	typeOfBool    = reflect.Bool.String()
	typeOfFloat64 = reflect.Float64.String()
)
...
func bigqueryFieldTypeToGoType(bigqueryFieldType bigquery.FieldType) (goType string, pkg string, err error) {
	...
	case bigquery.DateFieldType:
		return typeOfDate, "cloud.google.com/go/civil", nil
	case bigquery.TimeFieldType:
		return typeOfTime, "cloud.google.com/go/civil", nil
	case bigquery.DateTimeFieldType:
		return typeOfDateTime, "cloud.google.com/go/civil", nil
	case bigquery.TimestampFieldType:
		return typeOfGoTime, "time", nil
	case bigquery.NumericFieldType:
		return typeOfRat, "math/big", nil
