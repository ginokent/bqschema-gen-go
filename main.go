...
func Run(ctx context.Context) error {
	...
	code, err := Generate(ctx, client, dataset)
	if err != nil {
		return fmt.Errorf("Generate: %w", err)
	}

	// NOTE(djeeno): output
	if err := ioutil.WriteFile(filePath, code, 0644); err != nil {
...
func Generate(ctx context.Context, client *bigquery.Client, dataset string) (code []byte, err error) {

	const (
		head = "// Code generated by go run github.com/djeeno/bqtableschema; DO NOT EDIT.\n" +
			"//go:generate go run github.com/djeeno/bqtableschema\n\n" +
	...
	// NOTE(djeeno): combine
	generatedCode := head + importCode + tail
